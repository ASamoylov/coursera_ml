#!/usr/bin/env python
"""
    Small example of interaction with MICEX ISS server.

    Version: 1.0
    Developed for Python 2.6

    Requires iss_simple_client.py library.
    Note that the valid username and password for the MICEX ISS account
    are required in order to perform the given request for historical data.

    @copyright: 2010 by MICEX
"""
...
class MyDataHandler(MicexISSDataHandler):
    """ This handler will be receiving pieced of data from the ISS client.
    """
